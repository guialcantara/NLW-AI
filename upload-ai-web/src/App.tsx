      ...
      <main className='flex-1 p-6 flex gap-6'>
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <p className='text-sm text-muted-foreground'>
            ...
            no seu prompt para adicionar a transcrição do vídeo selecionado
          </p>
        </div>
          ...
          <form className='space-y-4'>
            ...
            <div className='space-y-4'>
              ...
              <Slider
                ...
                step={0.1}
              />
              <span className='block text-xs text-muted-foreground leading-relaxed italic'>Valores mais altos tendem a deixar o resultado mais criativo e com possíveis erros</span>
            </div>
            <Separator />
            <Button type='submit' className='w-full'>
              Executar
